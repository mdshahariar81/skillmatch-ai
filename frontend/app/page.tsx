...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16 lg:py-24">
          <div>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <Benefit icon={<Sparkles className="h-4 w-4" />} title="AI Analysis" />
              <Benefit icon={<ArrowRight className="h-4 w-4" />} title="Career Insights" />
              <Benefit icon={<Lock className="h-4 w-4" />} title="100% Private" />
            </div>
          </div>

          <div className="w-full">
            <CVUpload onAnalysisComplete={setAnalysis} />
          </div>
        </div>
      </section>
      ...
      <section id="about" className="border-t border-border/70 bg-card/40">
      ...
      <footer className="border-t border-border bg-background">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-7 sm:px-8 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm font-bold text-foreground">SkillMatch AI</p>
          ...
          <div className="flex items-center gap-5 text-sm">
            <Link href="/team/shahariar" className="cursor-pointer font-semibold text-foreground transition-colors duration-200 hover:text-primary">
              Frontend Developer
            </Link>
            <Link href="/team/sujoypal" className="cursor-pointer font-semibold text-foreground transition-colors duration-200 hover:text-primary">
              Backend Developer
            </Link>
          </div>
        </div>
